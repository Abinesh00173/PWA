  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <h3 style={styles.title}>🐍 Snake</h3>
          ...
          <div style={styles.controlsPanel}>
            ...
            <div style={styles.dpadContainer}>
              ...
              <div style={styles.dpadRow}>
                ...
                <button 
                  style={{ ...styles.controlBtn, ...styles.centerBtn }}
                  onClick={togglePause}
                >
                  {gameStatus === 'paused' ? '▶' : '⏸'}
                </button>
            ...
            {isDesktop && (
              <div style={styles.statsPanel}>
                <div style={styles.statRow}>
                  ...
                  <span style={styles.statValue}>{Math.round((220 - speed) / 80 * 100)}%</span>
                </div>
                <div style={styles.statRow}>
                  <span style={styles.statLabel}>Length</span>
                  <span style={styles.statValue}>{gameStateRef.current.body?.length || 3}</span>
                </div>
              </div>
            )}
            
            <div style={styles.hint}>
              {isDesktop ? 'WASD or Arrow Keys' : 'Tap D-pad to move'}
            </div>
          </div>
        )}
      </div>
